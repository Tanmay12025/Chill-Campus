  ...
  return (
    <div className="space-y-6 py-4">
      ...
      <div className="border-t pt-6">
        <h2 className="text-xl font-bold mb-4">VIT Bhopal University</h2>
        
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="dashboard-card md:col-span-2">
            <h3 className="text-lg font-semibold mb-3">About</h3>
            <p className="text-sm text-muted-foreground mb-4">
              VIT Bhopal University is one of India's leading institutions known for academic excellence and innovative research. 
              Established with a vision to provide world-class education, VIT Bhopal offers a wide range of undergraduate, 
